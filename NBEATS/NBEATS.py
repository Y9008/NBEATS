...
class NeuralBeats:   
    def __init__(self,forecast_length,data=None, backcast_length=None,save_model=False,path='',checkpoint_name='NBEATS-checkpoint.th',mode='cpu',batch_size=None,thetas_dims=[4, 8],nb_blocks_per_stack=3,share_weights_in_stack=False,train_percent=0.8,hidden_layer_units=128,stack=None):
        if (data is None):
